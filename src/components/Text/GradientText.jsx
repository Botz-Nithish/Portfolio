export default function GradientText({
    ...
    return (
      <div
        className={`relative ml-[7vw] mb-[2vw] flex-row items-center justify-center font-medium transition-shadow duration-500 overflow-hidden cursor-pointer ${className}`}
      >
        {showBorder && (
          <div
